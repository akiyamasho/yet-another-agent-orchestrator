...
export type AgentProvider = "codex" | "claude" | "pi";
...
export interface CreateThreadInput { folderId: string; parentId?: string; provider?: AgentProvider; title: string; objective: string; acceptanceCriteria?: string[]; profile?: string; model?: string; reasoningEffort?: string; permission?: PermissionMode; branch?: string; }
